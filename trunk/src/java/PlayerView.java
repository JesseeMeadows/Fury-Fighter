...
public class PlayerView extends View{
	...
	public void render(Graphics2D g2, float rw, float rh){ 
		...
		if(this.playerModel.getDefensePodLevel()>0){
			...
			g2.drawImage(this.playerModel.getDefensePodImage(),drawx,drawy,(int)rw*this.playerModel.getDefensePodImage().getWidth(),(int)rh*this.playerModel.getDefensePodImage().getHeight(),null);
		}
		...
		if(this.playerModel.getCobaltDt() > 0){
			for(int xx=0;xx<30;xx++){
				...
				g2.drawImage(this.playerModel.getCobaltBombImage(),drawx,drawy,(int)rw*this.playerModel.getCobaltBombImage().getWidth(),(int)rh*this.playerModel.getCobaltBombImage().getHeight(),null);
			}
		}
